...
faq:
  ...
  - q: "What is the structural risk to Atypica.AI?"
...
Atypica.AI's structural attack is the bottom of the market, where the buyer is most price-sensitive and the output quality is least differentiated. The middle compresses but does not collapse — the senior-refinement layer is real. The top is untouched.

## Why '30 minutes' is the model, not the quality

The case frames 30 minutes as the headline. The 30-minute output is a junior-consultant first draft, not a partner-grade report. The structural argument is not that Atypica.AI's output is better — it is that the 30-minute output is good enough to displace the bottom of the market, where 5K USD per report was the price floor for human labor.
