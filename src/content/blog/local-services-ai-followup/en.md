...
description: "A look at a $12/month Google Sheet + auto-email 'customer follow-up' product sold to a local blue-collar service business (HVAC). How it runs: a Google Sheet tracks every install and auto-emails the owner when filters need swapping, warranties are about to lapse, or 6-month service is due. The interesting part is not the $12. It is the addressable market — local blue-collar service owners (plumbers, cleaners, landscapers, detailers) who still run follow-up in their head."
pubDate: 2026-07-09
category: 'ai'
tags: ['ai', 'automation', 'local-service', 'saas', 'case-study', 'monetization']
translationKey: 'local-services-ai-followup'
tldr: "A solo operator built a $12/month Google Sheet + auto-email 'customer follow-up' product for a local HVAC owner. The product reminds the owner when filters need swapping, warranties are about to lapse, or 6-month service is due. It now runs at $24/month across two shops. The interesting part is not the $24. It is the addressable market — local blue-collar service owners (plumbers, cleaners, landscapers, detailers) who still run follow-up in their head and lose repeat revenue because of it. AI plays a small role; the reminder is what sells."
faq:
  ...
  - q: "Why does a $12/month product matter?"
    a: "It doesn't, on its own. What matters is the size of the addressable market: every local blue-collar service business (plumber, cleaner, landscaper, detailer, pest control, appliance repair) runs follow-up in the operator's head. There are millions of them in the US alone. A $12/month product with low churn, sold shop-by-shop through local relationships, scales to $10K–$50K/month while keeping single-shop margins."
...
Per-shop revenue doesn't matter. What matters is how many shops the operator can sign.
...
So in 2026, the AI tools market is saturated, and the AI-leveraged local-services market is not. The competition for the latter is ServiceTitan, Housecall Pro, and Jobber — but those products are priced at $200–$500/month and require multi-day onboarding. A $12/month Google Sheet sold by a person over a cup of coffee is not in their market.
...
This is not 'a Google Sheet made $24/month'. It is a $12/month product, sold shop-by-shop in a local relationship, scaling to a real business because the addressable market (local blue-collar service businesses running follow-up in their head) is in the millions. The AI role is the auto-email. The reminder is the actual product.

Stop building AI tools. Walk into 10 local shops in your town. Offer to set up a Google Sheet reminder system for $12/month. The product takes an afternoon to build. The relationship is the moat. The repeat revenue compounds shop by shop.
