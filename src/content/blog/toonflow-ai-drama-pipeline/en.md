...
faq:
  ...
  - q: "What is the risk to Toonflow?"
  ...
  - q: "What does it skip?"
    a: "Four gaps. (1) Per-episode cost — the case does not name the dollar figure. (2) Failure modes — what happens when a 6-agent pipeline produces an inconsistent shot; the user has limited manual override. (3) Quality ceiling — the case says 6-agent orchestration is the breakthrough, but does not address the upper bound on output quality (cinematic short drama vs vertical short drama). (4) Distribution CAC — the case does not address the cost of getting a paying viewer; the production cost is the small part of the unit economics."
---
