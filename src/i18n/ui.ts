...
const en: UIDict = {
  ...
  'home.sections.eyebrow': 'What you will find here',
  'home.sections.title': 'Three editorial surfaces, each with a clear job',
  'home.sections.subtitle': 'Pick the surface that matches your need. Every section has a stable URL, an RSS feed, and a recent-update list.',
  'home.section.tools.title': 'Calculators',
  'home.section.tools.body': 'Five browser-side tools that answer pricing, chargeable weight, fee comparison, break-even ROAS and FX withdrawal in under 30 seconds. No login, no email gate.',
  'home.section.tools.link': 'See all calculators',
  'home.section.ai.title': 'AI Lab',
  'home.section.ai.body': 'Case studies on independent AI products — ARR, business model, content flywheel and failure modes. Sourced from public posts and filings, summarized with first-party analysis.',
  'home.section.ai.link': 'Browse AI Lab cases',
  'home.section.guides.title': 'Guides',
  'home.section.guides.body': 'Step-by-step walkthroughs on the questions cross-border sellers ask most: FBA fees, ePacket replacements, Stripe vs PayPal, content-site monetization.',
  'home.section.guides.link': 'Read all guides',
  // Blog / content UI
...
const zh: UIDict = {
  ...
  'home.sections.eyebrow': '你能在本站找到什么',
  'home.sections.title': '三个内容板块，每个职责明确',
  'home.sections.subtitle': '按你的需要挑板块。每个板块都有稳定 URL、RSS 订阅和最近更新列表。',
  'home.section.tools.title': '计算器',
  'home.section.tools.body': '五款浏览器内运行的工具：定价、体积重、费率对比、保本 ROAS、汇率提现，30 秒内给出答案。无需登录、无需邮箱。',
  'home.section.tools.link': '查看全部计算器',
  'home.section.ai.title': 'AI 实验',
  'home.section.ai.body': '独立 AI 产品的案例研究 —— ARR、商业模式、内容飞轮、失败模式。来源取自公开文章与文件，附第一性分析。',
  'home.section.ai.link': '浏览 AI 实验案例',
  'home.section.guides.title': '实操指南',
  'home.section.guides.body': '一步步拆解跨境卖家最常问的问题：FBA 费用、ePacket 替代方案、Stripe vs PayPal、内容站变现。',
  'home.section.guides.link': '查看全部指南',
  // Blog / content UI
  'blog.readMore': '继续阅读',
  'blog.minutes': '分钟阅读',
